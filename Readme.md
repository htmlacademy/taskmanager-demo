...
Учебный демо-проект от HTML Academy для 21 потока профессионального онлайн‑курса «JavaScript. Архитектура клиентских приложений».

## Как пользоваться репозиторием

Первый вариант, это изучать коммиты [в веб-интерфейсе GitHub в main-ветке потока](https://github.com/htmlacademy-ecmascript/taskmanager-21).
